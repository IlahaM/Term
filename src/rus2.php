...
<br>
	  ...
	  <div class="ma-featured-sldier-title"> 
	        	<h1>Ловец огней на звездном поле</h1>
</div>
					<div class="product-img-box">
																																						<div class="product-img-big-box">
																								<a href="/upload/iblock/a46/a46ddfb6052e4c34578c43b41b2fd412.jpg" class="fancybox" id="product-img-big-38506" rel="group_668000">
								<img src="/upload/resize_cache/iblock/a46/183_220_1/a46ddfb6052e4c34578c43b41b2fd412.jpg" height="220" width="136" border="0" alt="Ловец огней на звездном поле" style="padding-top:0px">
							</a>
															</div>
					...
					668000				
				   		...
				   		<span>
				   			Роман/Roman						</span>
													 						 ...
													 						 <div class="ds_field">
							ISBN:<span>&nbsp;9785699972074</span>
						</div>
														 						 <div class="ds_field">
							Müəllif:<span>&nbsp;Чарльз Мартин</span>
						</div>
														 						 <div class="ds_field">
...
<div class="ds_field">məhsul mövcudluğu:<span>&nbsp;
				bəli</span></div>
												...
												<div class="product-shop">
				<div class="price-box"><s>12,00 AZN</s>&nbsp;&nbsp;<span class="discount_b">%15</span>&nbsp;&nbsp;  <span class="regular-price" id="product-price-1">10,20 AZN</span></div>
				 <div class="b_vote">
<span>
<div class="iblock-vote" id="vote_668129">
				...
				&nbsp; &nbsp; &nbsp;<button class="button" onclick="jQuery('#fast_order_container').fadeIn(100)"><span><span>Tıkla-al</span></span></button>
						...
						<br>Чейз Уокер всю жизнь разыскивал своего настоящего отца, но его попытки так и не увенчались успехом. Когда волей случая ему приходится принять участие в судьбе Майки, десятилетнего сироты, найденного возле железной дороги, Чейз решает, что не в силах смириться с тем, что еще одно детство загублено, и берет ребенка на воспитание. Неожиданно этот поступок приоткрывает завесу и в его собственной истории. Распутывая загадки прошлого, Чейз следует опасной дорогой. Но есть ли что-то или кто-то, способный ему помешать?<br>
