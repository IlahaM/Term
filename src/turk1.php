...
<br>
	  ...
	  <div class="ma-featured-sldier-title"> 
	       <h3>Asi Kızlara Uykudan Önce Hikayeler</h3>
</div>
					<div class="product-img-box">
								...
								<img src="../picture/7.jpg" height="220" width="165" border="0" alt="Asi Kızlara Uykudan Önce Hikayeler" style="padding-top:0px">
							</a>
															</div>
