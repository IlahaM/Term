...
<div class="product-name">
					...
					<div class="product-img-box">
								...
								<img src="../picture/3.jpg" height="220" width="159" border="0" alt="İtmiş dünya " style="padding-top:0px">
							</a>
															</div>
				...
				<div class="ds_field">
					...
					668127				
				   		...
				   		Janr:
				   		<span>
				   			Детская литераура/Uşaq ədəbiyyatı						</span>
					</div>
													 						 <div class="ds_field">
							ISBN:<span>&nbsp;9789952364132</span>
						</div>
														 						 <div class="ds_field">
							Müəllif:<span>&nbsp;Artur Konan Doyl</span>
						</div>
														 						 <div class="ds_field">
...
<div class="ds_field">məhsul mövcudluğu:<span>&nbsp;
				bəli</span></div>
												...
												<div class="product-shop">
				<div class="price-box"><s>4,99 AZN</s>&nbsp;&nbsp;<span class="discount_b">%15</span>&nbsp;&nbsp;  <span class="regular-price" id="product-price-1">4,24 AZN</span></div>
				 <div class="b_vote">
<span>
<div class="iblock-vote" id="vote_668129">
				...
				&nbsp; &nbsp; &nbsp;<button class="button" onclick="jQuery('#fast_order_container').fadeIn(100)"><span><span>Tıkla-al</span></span></button>
						...
						<br>“İtmiş dünya” romanı ingilis yazıçısı Artur Konan Doylun professor Çellencer silsiləsindən olan ilk əsəridir. Romanda britaniyalı ekspedisiya üzvlərinin Cənubi Amerikaya qeyri-adi səyahətindən bəhs olunur.<br>
<br>
Sıldırım qayalıqların arxasına sığınan yaylada professor Çellencer ekspedisiya yoldaşları professor Sammerli, lord Con Rokston və müxbir Melounla birlikdə dinozavrlarla, qeyri-adi canlılarla, insanabənzər meymunlar və ibtidai insanları xatırladan xalqla üz-üzə durub. Bura – “itmiş dünya”dır və bu dünyanın öz qanunları var.<br>
<br>
Görəsən, vətəndən ayrı düşən, geri qayıtmağa bütün yolları bağlanan ekspedisiya üzvləri bu qədər çətinlik və təhlükə qarşısında duruş gətirib Britaniyaya dönə biləcəkrmi?!<br>
