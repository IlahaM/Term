...
<br>
	  ...
	  <div class="ma-featured-sldier-title"> 
	        	<h3>IX Karlın hakimiyyət tarixçəsi</h3>
	       	</div>
...
<div class="product-name">
					...
					<div class="product-img-box">
								...
								<img src="../picture/2.png" height="220" width="159" border="0" alt="IX Karlın hakimiyyət tarixçəsi " style="padding-top:0px">
							</a>
															</div>
				...
				<div class="ds_field">
					...
					668128				
				   		...
				   		Janr:
				   		<span>
				   			Классика/Klassika						</span>
					</div>
													 						 <div class="ds_field">
							ISBN:<span>&nbsp;9789952364255</span>
						</div>
														 						 <div class="ds_field">
							Müəllif:<span>&nbsp;Prosper Merime</span>
						</div>
														 						 <div class="ds_field">
							Nəşriyyat:<span>&nbsp;Əli və Nino Nəşriyyatı və Qanun Nəşriyyatı</span>
						</div>
														 						 <div class="ds_field">
...
<div class="ds_field">məhsul mövcudluğu:<span>&nbsp;
				bəli</span></div>
												...
												<div class="product-shop">
				<div class="price-box"><s>7,49 AZN</s>&nbsp;&nbsp;<span class="discount_b">%15</span>&nbsp;&nbsp;  <span class="regular-price" id="product-price-1">6,37 AZN</span></div>
				 <div class="b_vote">
<span>
<div class="iblock-vote" id="vote_668129">
				...
				&nbsp; &nbsp; &nbsp;<button class="button" onclick="jQuery('#fast_order_container').fadeIn(100)"><span><span>Tıkla-al</span></span></button>
						...
						<br>Bu kitab məşhur novella ustası Prosper Merimenin yeganə tarixi romanıdır. Roman Fransa tarixinə qanla yazılmış XVI əsrdə baş verən dini-vətəndaş müharibəsindən bəhs edir. Əsərin qəhrəmanı tarixi dövrdür, vətəndaş müharibəsinin hələ də sönməyən alovları, insanı qardaş qatilinə çevirən bir dövr; surətlər isə cəmiyyət adlanan toplunun ayrı-ayrı iştirakçılarıdır.<br>
<br>
Əsərin süjet xətti bu dövrə təsadüf edən, Bernar Merjinin başına gələn sərgüzəştlərdən ibarətdir. Zəmanəsinin qurbanı olan müsbət və gənc qəhrəman Bernar amansız döyüş zamanı özü də bilmədən sevimli qardaşının qatilinə çevrilir.<br>
<br>
Macəralarla dolu roman oxucunu Fransa cəmiyyətində baş verən hadisələrin müşahidəçisi və xəyali iştirakçısı edir.<br>
